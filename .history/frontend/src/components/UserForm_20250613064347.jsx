...
const UserForm = ({ onSave, onCancel }) => {
  ...
  return (
    <Form id="signup" onSubmit={handleSubmit} style={{ top: 64 }}>
      ...
      <Row className="centerDiv mt-3">
        <Button type="submit" className="btn btn-default otbutton">
          <img className="images-save" src="/images/empty.png" alt="" /> Gravar
        </Button>
        <Button
          type="button"
          as={Link}
