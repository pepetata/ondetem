...
import { useFormFields } from "./frontend/src/hooks";
import { userFormFields } from "./backend/shared/formfields/userFormFields";
import OTButton from "./frontend/src/components/OTButton";
      ...
      <Form id="signup" onSubmit={handleSubmit}>
        <Row className="userData">
          <Col md={6}>
            ...
            <FormInput field={fields.nickname} />
            <FormInput field={fields.email} />
            <FormInput field={fields.password} />
            <FormInput field={fields.confirmpassword} />
            {/* <Form.Group className="required">
